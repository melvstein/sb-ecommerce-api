...
import com.melvstein.ecommerce.api.domain.customer.dto.FilterPartsDto;
...
public class CustomerRepositoryImpl implements CustomerRepositoryCustom {
    ...
    @Override
    public List<Customer> filter(List<String> filter, Pageable pageable) {
        Query query = new Query();
        List<Criteria> andCriteriaList = new ArrayList<>();
        List<Criteria> orCriteriaList = new ArrayList<>();

        // Always include active customers only
        andCriteriaList.add(Criteria.where("username").exists(true));
